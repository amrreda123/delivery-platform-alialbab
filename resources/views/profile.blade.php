...
<div class="bg-[#0B1536] py-16 text-center text-white relative">
    ...
    <!-- Settings Button -->
    <div class="absolute bottom-6 right-1/2 translate-x-1/2 flex gap-3">
        <a href="{{ route('profile.settings') }}" class="bg-white/10 hover:bg-white/20 text-white px-6 py-2 rounded-xl text-sm font-bold transition flex items-center gap-2 border border-white/20 backdrop-blur-sm">
