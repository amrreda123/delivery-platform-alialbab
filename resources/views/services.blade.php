...
<section class="py-20 px-6 md:px-12 bg-white relative">
    <div class="max-w-7xl mx-auto relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- Service: Any Item -->
            <div data-aos="fade-up" data-aos-delay="100" class="group bg-white rounded-[24px] p-8 border border-gray-100 hover-lift hover:border-yellow-300 hover:shadow-[0_20px_40px_-15px_rgba(255,193,7,0.3)] transition-all duration-500 cursor-pointer">
            ...
            <!-- Service: Supermarket -->
            <div data-aos="fade-up" data-aos-delay="200" class="group bg-white rounded-[24px] p-8 border border-gray-100 hover-lift hover:border-blue-300 hover:shadow-[0_20px_40px_-15px_rgba(59,130,246,0.3)] transition-all duration-500 cursor-pointer">
            ...
            <!-- Service: Pharmacies -->
            <div data-aos="fade-up" data-aos-delay="300" class="group bg-white rounded-[24px] p-8 border border-gray-100 hover-lift hover:border-teal-300 hover:shadow-[0_20px_40px_-15px_rgba(20,184,166,0.3)] transition-all duration-500 cursor-pointer">
            ...
            <!-- Service: Restaurants -->
            <div data-aos="fade-up" data-aos-delay="400" class="group bg-white rounded-[24px] p-8 border border-gray-100 hover-lift hover:border-orange-300 hover:shadow-[0_20px_40px_-15px_rgba(249,115,22,0.3)] transition-all duration-500 cursor-pointer">
            ...
            <!-- Service: Clothes -->
            <div data-aos="fade-up" data-aos-delay="500" class="group bg-white rounded-[24px] p-8 border border-gray-100 hover-lift hover:border-purple-300 hover:shadow-[0_20px_40px_-15px_rgba(139,92,246,0.3)] transition-all duration-500 cursor-pointer">
            ...
            <!-- Service: Corporate -->
            <div data-aos="fade-up" data-aos-delay="600" class="group bg-[#FAFAFA] rounded-[24px] p-8 border border-dashed border-gray-300 hover:border-gray-400 hover:bg-gray-100 transition-all duration-300 flex flex-col items-center justify-center text-center cursor-pointer">
