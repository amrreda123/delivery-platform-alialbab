...
<section class="py-20 bg-[#FAFAFA] relative z-20">
    <div class="max-w-5xl mx-auto px-6 md:px-12">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <!-- WhatsApp -->
            <a href="{{ $settings['whatsapp_link'] ?? '#' }}" target="_blank" class="flex items-center gap-6 p-6 bg-white rounded-[24px] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group" data-aos="fade-up" data-aos-delay="100">
            ...
            <!-- Facebook -->
            <a href="{{ $settings['facebook_link'] ?? '#' }}" target="_blank" class="flex items-center gap-6 p-6 bg-white rounded-[24px] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group" data-aos="fade-up" data-aos-delay="200">
            ...
            <!-- Instagram -->
            <a href="{{ $settings['instagram_link'] ?? '#' }}" target="_blank" class="flex items-center gap-6 p-6 bg-white rounded-[24px] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group" data-aos="fade-up" data-aos-delay="300">
            ...
            <!-- YouTube -->
            <a href="{{ $settings['youtube_link'] ?? '#' }}" target="_blank" class="flex items-center gap-6 p-6 bg-white rounded-[24px] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group" data-aos="fade-up" data-aos-delay="400">
            ...
            <!-- TikTok -->
            <a href="{{ $settings['tiktok_link'] ?? '#' }}" target="_blank" class="flex items-center gap-6 p-6 bg-white rounded-[24px] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group" data-aos="fade-up" data-aos-delay="500">
        ...
        <div data-aos="fade-up" data-aos-delay="100" class="group relative bg-white rounded-3xl p-8 flex flex-col items-center justify-center text-center border border-red-100 hover:shadow-2xl hover:shadow-red-200/50 transition-all duration-300 overflow-hidden min-h-[280px]">
            ...
            <div class="relative z-10 flex flex-col items-center w-full">
                ...
                <div class="bg-white/80 backdrop-blur-sm px-6 py-4 rounded-xl shadow-sm border border-red-100 w-full mb-3 flex items-center justify-between group-hover:border-red-300 transition-colors relative overflow-hidden">
                    ...
                    <span class="font-black text-2xl lg:text-3xl text-[#E60000] tracking-[0.1em] relative z-10 font-mono">{{ $settings['vodafone_cash_number'] ?? '01060401725' }}</span>
                    <button onclick="navigator.clipboard.writeText('{{ $settings['vodafone_cash_number'] ?? '01060401725' }}')" class="text-red-300 hover:text-[#E60000] hover:bg-red-50 p-2 rounded-lg transition-all relative z-10" title="نسخ الرقم">
        ...
        <div data-aos="fade-up" data-aos-delay="200" class="group relative bg-white rounded-3xl p-8 flex flex-col items-center justify-center text-center border border-green-100 hover:shadow-2xl hover:shadow-green-200/50 transition-all duration-300 overflow-hidden min-h-[280px]">
            ...
            <div class="relative z-10 flex flex-col items-center w-full">
                ...
                <div class="bg-white/80 backdrop-blur-sm px-6 py-4 rounded-xl shadow-sm border border-green-100 w-full mb-3 flex items-center justify-between group-hover:border-[#73C044]/40 transition-colors relative overflow-hidden">
                    ...
                    <span class="font-black text-2xl lg:text-3xl text-[#73C044] tracking-[0.1em] relative z-10 font-mono">{{ $settings['etisalat_cash_number'] ?? '01130424003' }}</span>
                    <button onclick="navigator.clipboard.writeText('{{ $settings['etisalat_cash_number'] ?? '01130424003' }}')" class="text-green-300 hover:text-[#73C044] hover:bg-[#73C044]/10 p-2 rounded-lg transition-all relative z-10" title="نسخ الرقم">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>
                    </button>
                </div>
