...
@section('title', 'تفاصيل المندوب: ' . $driver->name)
@section('page-title', 'ملف المندوب')
@section('page-subtitle', 'عرض إحصائيات المندوب وسجل الطلبات')
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="glass-card p-6 flex items-center gap-4">
            ...
            <div>
                <h3 class="text-xl font-bold text-[#0B1536]">{{ $driver->name }}</h3>
        ...
        <div class="glass-card p-6 flex items-center gap-4 border-r-4 border-emerald-500">
            ...
            <div>
                <p class="text-sm font-semibold text-gray-500 mb-1">أرباح التوصيل (المكتملة)</p>
                <h4 class="text-2xl font-black text-[#0B1536]">{{ number_format($totalDeliveryFees, 2) }} <span class="text-sm font-medium text-gray-400">ج.م</span></h4>
            </div>
        </div>
    </div>
    ...
    <div class="glass-card p-6" data-aos="fade-up">
        <h3 class="text-xl font-bold text-[#0B1536] mb-6">سجل الطلبات</h3>
            ...
            <table class="w-full text-right whitespace-nowrap">
                <thead>
                    <tr class="bg-gray-50 border-b border-gray-100">
                        ...
                        <th class="px-4 py-3 font-semibold text-gray-500 text-sm">رسوم التوصيل</th>
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        <td class="px-4 py-3">
                            <span class="font-bold text-[#0B1536]">#{{ $order->id }}</span>
                        </td>
                        <td class="px-4 py-3">
                            <div class="font-semibold text-gray-800">{{ $order->customer->name ?? 'غير متوفر' }}</div>
                        ...
                        <td class="px-4 py-3">
                            <span class="font-bold text-emerald-600">{{ number_format($order->delivery_fee, 2) }} ج.م</span>
                        </td>
                        <td class="px-4 py-3">
                    ...
                    @empty
                    <tr>
                        <td colspan="7" class="px-4 py-8 text-center text-gray-500 font-semibold">لم يقم هذا المندوب بتوصيل أي طلبات حتى الآن.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
