...
@php
    ...
    switch($category->icon) {
        case 'clothes-icon':
            $bgHover = 'from-[#f5f2f9] to-[#ede9f6]';
            $iconBg = 'from-[#8B5CF6] to-[#7C3AED]';
            $shadow = 'shadow-purple-100/60';
            $barBg = 'from-[#8B5CF6] to-[#7C3AED]';
        ...
        case 'restaurant-icon':
            $bgHover = 'from-[#fff7f0] to-[#fff0e6]';
            $iconBg = 'from-[#F97316] to-[#EA580C]';
            $shadow = 'shadow-orange-100/60';
            $barBg = 'from-[#F97316] to-[#EA580C]';
            ...
            break;
        case 'pharmacy-icon':
            $bgHover = 'from-[#f0fdfb] to-[#e6f9f7]';
            $iconBg = 'from-[#14B8A6] to-[#0D9488]';
            $shadow = 'shadow-teal-100/60';
            $barBg = 'from-[#14B8A6] to-[#0D9488]';
        ...
        case 'supermarket-icon':
            $bgHover = 'from-[#eff6ff] to-[#e8f0fe]';
            $iconBg = 'from-[#3B82F6] to-[#2563EB]';
            $shadow = 'shadow-blue-100/60';
            $barBg = 'from-[#3B82F6] to-[#2563EB]';
        ...
        case 'custom-icon':
        default:
            $bgHover = 'from-[#fffbeb] to-[#fef3c7]';
            $iconBg = 'from-[#FFC107] to-[#F59E0B]';
            $shadow = 'shadow-yellow-100/60';
            $barBg = 'from-[#FFC107] to-[#F59E0B]';
...
<div data-aos="fade-up" data-aos-delay="{{ $delay }}" class="service-card group relative bg-white rounded-[24px] p-6 flex flex-col items-center text-center cursor-pointer border border-gray-100/80 hover:-translate-y-2 hover:shadow-2xl hover:{{ $shadow }} transition-all duration-300 overflow-hidden">
    ...
    <div class="relative z-10 flex flex-col items-center">
        <div class="w-20 h-20 mb-5 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-md bg-gradient-to-br {{ $iconBg }}">
            {!! $svg !!}
        </div>
        <h3 class="font-bold text-base text-[#0B1536] mb-1.5 leading-tight">{{ $category->name }}</h3>
