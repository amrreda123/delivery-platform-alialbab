...
<div class="bg-[#0B1536] py-16 text-center text-white relative">
    ...
    <div class="absolute top-6 right-6">
        <a href="{{ route('driver.settings') }}" class="bg-white/10 hover:bg-white/20 text-white px-4 py-2 rounded-xl text-sm font-bold transition flex items-center gap-2 border border-white/20">
